...
class ContentRequest extends FormRequest
{
    ...
    public function rules()
    {
        return  [
            ...
            'zuozhe' => 'required|string|between:1,20',
    ...
    public function messages()
    {
         return   [
             ...
             'zuozhe.required'=>'作者 不能为空',
             'zuozhe.string'=>'作者 提交类型不对',
             'zuozhe.between'=>'作者 1-20个字符',
             'editor.required'=>'编辑人 不能为空',
             'editor.string'=>'编辑人 1-20个字符',
             'editor.between'=>'编辑人 不能为空',
