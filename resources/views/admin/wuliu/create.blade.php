...
@section('content')
			...
			<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-magic"></i> 添加厂商</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        ...
                        <form id="mws-wizard-form" class="mws-form wizard-form wizard-form-horizontal" action="/admin/wuliu" method="post">
                            {{csrf_field()}}
                            ...
                            <fieldset id="step-2" class="mws-form-inline" data-wzd-id="wzd_1chldfu33d7iua1b25_1" style="display: block;">
                                ...
                                <div class="mws-form-row">
                                    <label class="mws-form-label">添加厂商名称 <span class="required">*</span></label>
                                    <div class="mws-form-item">
                                        <input type="text" name="cname" class="required large" />
                                    </div>
                                </div>
